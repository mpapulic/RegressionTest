...
namespace RegressionTest
{
    ...
    public class AdministrationPreferencesVeryUrgentDay : WebTest
    {

        public AdministrationPreferencesVeryUrgentDay()
        {
            ...
            this.Context.Add("IsUrgentSubmission", "false");
            this.Context.Add("IsVeryUrgentSubmission", "true");
            this.Context.Add("DaysInPast", "18");
